...
void RenderScene() //Zeichenfunktion
{
   // Hier befindet sich der Code der in jedem Frame ausgefuehrt werden muss
	...
	glRotatef( -45., 0., 0., 1.);			//Durch Push und Pop Matrix kann ich die einzelnen Objekte eigenständig behandeln
...
void Reshape(int width,int height)
{
   ...
   // Graphikfensters statt
	...
	gluLookAt ( 0., 0., 1., 0., 0., 0., 0., 1., 0.);		//Betrachte den Würfel von Vorne Oben
